...
func (x *VerifyCaptchaReq) GetPhoneNumber() *v11.PhoneNumber {
	if x != nil {
...
type VerifyCaptchaReq_PhoneNumber struct {
	PhoneNumber *v11.PhoneNumber `protobuf:"bytes,4,opt,name=phone_number,json=phoneNumber,proto3,oneof"`
}
...
type SendCaptchaResp_Data struct {
	...
	// 如果报错，这里有限制的原因
	Limit         *v11.LimitRule `protobuf:"bytes,2,opt,name=limit,proto3" json:"limit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_message_v1_captcha_proto_rawDesc = "" +
	...
	"\xbaH\ar\x05\x90\xa1\xe9\x03\x01R\acaptcha\x12E\n" +
	"\fphone_number\x18\x04 \x01(\v2\x16.common.v1.PhoneNumberB\b\xbaH\x05r\x03\x98\x01\vH\x00R\vphoneNumber\x12\x1f\n" +
