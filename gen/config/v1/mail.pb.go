...
func (x *MailProvider) Reset() {
	*x = MailProvider{}
	mi := &file_config_v1_mail_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MailProvider) Descriptor() ([]byte, []int) {
	return file_config_v1_mail_proto_rawDescGZIP(), []int{1}
}
...
func (x *Mail) Reset() {
	*x = Mail{}
	mi := &file_config_v1_mail_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Mail) Descriptor() ([]byte, []int) {
	return file_config_v1_mail_proto_rawDescGZIP(), []int{2}
}
...
const file_config_v1_mail_proto_rawDesc = "" +
	"\n" +
	"\x14config/v1/mail.proto\x12\tconfig.v1\x1a\x16enums/v1/message.proto\x1a$validation/v1/predefined_rules.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bbuf/validate/validate.proto\"\xed\x01\n" +
	"\x04SMTP\x12\x1b\n" +
	...
	"\xbaH\a\xaa\x01\x042\x02\b\x01R\atimeout\"\xc6\x02\n" +
	"\fMailProvider\x129\n" +
	...
	"\x04smtp\x18\x06 \x01(\v2\x0f.config.v1.SMTPB\x06\xbaH\x03\xc8\x01\x01R\x04smtp\"=\n" +
	"\x04Mail\x125\n" +
	"\tproviders\x18\x01 \x03(\v2\x17.config.v1.MailProviderR\tprovidersB\x93\x01\n" +
	"\rcom.config.v1B\tMailProtoP\x01Z2github.com/byteflowing/base/gen/config/v1;configv1\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
...
var file_config_v1_mail_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_config_v1_mail_proto_goTypes = []any{
	(*SMTP)(nil),                // 0: config.v1.SMTP
	(*MailProvider)(nil),        // 1: config.v1.MailProvider
	(*Mail)(nil),                // 2: config.v1.Mail
	(*durationpb.Duration)(nil), // 3: google.protobuf.Duration
	(v1.MailVendor)(0),          // 4: enums.v1.MailVendor
}
var file_config_v1_mail_proto_depIdxs = []int32{
	3, // 0: config.v1.SMTP.timeout:type_name -> google.protobuf.Duration
	4, // 1: config.v1.MailProvider.vendor:type_name -> enums.v1.MailVendor
	3, // 2: config.v1.MailProvider.limit_duration:type_name -> google.protobuf.Duration
	0, // 3: config.v1.MailProvider.smtp:type_name -> config.v1.SMTP
	1, // 4: config.v1.Mail.providers:type_name -> config.v1.MailProvider
