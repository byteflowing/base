...
type SmsMessage struct {
	...
	Combination CaptchaCombination `protobuf:"varint,3,opt,name=combination" json:"combination,omitempty"`    // 验证码组合类型
...
func (x *SmsMessage) GetCombination() CaptchaCombination {
	if x != nil {
		return x.Combination
	}
	return CaptchaCombination_CAPTCHA_COMBINATION_UNSPECIFIED
}
...
type PagingGetSmsMessageOptions struct {
	...
	CaptchaCombinations []CaptchaCombination `protobuf:"varint,7,rep,packed,name=captcha_combinations" json:"captcha_combinations,omitempty"` // in查询
	Provider            []SmsProvider        `protobuf:"varint,8,rep,packed,name=provider" json:"provider,omitempty"`                         // in查询
	MsgTypes            []MessageType        `protobuf:"varint,9,rep,packed,name=msg_types" json:"msg_types,omitempty"`                       // in查询
	MsgStatus           []MessageStatus      `protobuf:"varint,10,rep,packed,name=msg_status" json:"msg_status,omitempty"`                    // in查询
	Templates           []string             `protobuf:"bytes,11,rep,name=templates" json:"templates,omitempty"`                              // in查询
	Signs               []string             `protobuf:"bytes,12,rep,name=signs" json:"signs,omitempty"`                                      // in查询
}
...
func (x *PagingGetSmsMessageOptions) GetCaptchaCombinations() []CaptchaCombination {
	if x != nil {
		return x.CaptchaCombinations
	}
	return nil
}
...
func (x *SendCaptchaReq) GetMsgType() CaptchaCombination {
	if x != nil {
		return x.MsgType
	}
	return CaptchaCombination_CAPTCHA_COMBINATION_UNSPECIFIED
...
func (x *SendCaptchaReq) GetProvider() SmsProvider {
...
type VerifyCaptchaReq struct {
	...
	Phone       *string       `protobuf:"bytes,4,opt,name=phone" json:"phone,omitempty"`                // [可选]手机号码
	Email       *string       `protobuf:"bytes,5,opt,name=email" json:"email,omitempty"`                // [可选]邮箱
}
...
func (x *VerifyCaptchaReq) GetPhone() string {
	if x != nil && x.Phone != nil {
		return *x.Phone
	}
	return ""
