...
import (
	...
	"github.com/byteflowing/base/app/internal"
...
type Impl struct {
	...
	shortIDGen    *internal.ShortIDGenerator
	globalIDGen   internal.GlobalIdGenerator
...
func New(
	...
	shortIDGen *internal.ShortIDGenerator,
	globalIDGen internal.GlobalIdGenerator,
	_captcha message.Captcha,
	wechat *internal.WechatManager,
