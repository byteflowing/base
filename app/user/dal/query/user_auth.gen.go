...
func newUserAuth(db *gorm.DB, opts ...gen.DOOption) userAuth {
	...
	_userAuth.TenantID = field.NewString(tableName, "tenant_id")
	...
	_userAuth.OpenID = field.NewString(tableName, "open_id")
...
func (u *userAuth) WithContext(ctx context.Context) IUserAuthDo { return u.userAuthDo.WithContext(ctx) }

func (u userAuth) TableName() string { return u.userAuthDo.TableName() }

func (u userAuth) Alias() string { return u.userAuthDo.Alias() }

func (u userAuth) Columns(cols ...field.Expr) gen.Columns { return u.userAuthDo.Columns(cols...) }
