...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		db:           db,
		MessageSms:   newMessageSms(db, opts...),
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		db:           db,
		MessageSms:   q.MessageSms.clone(db),
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		db:           db,
		MessageSms:   q.MessageSms.replaceDB(db),
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		MessageSms:   q.MessageSms.WithContext(ctx),
