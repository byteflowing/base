...
type UserBasic struct {
	...
	Country       string  `gorm:"column:country;type:character varying(20);not null;index:idx_basic_admin_region,priority:2" json:"country"`
	Province      string  `gorm:"column:province;type:character varying(20);not null;index:idx_basic_admin_region,priority:4" json:"province"`
	City          string  `gorm:"column:city;type:character varying(20);not null;index:idx_basic_admin_region,priority:1" json:"city"`
	District      string  `gorm:"column:district;type:character varying(20);not null;index:idx_basic_admin_region,priority:3" json:"district"`
