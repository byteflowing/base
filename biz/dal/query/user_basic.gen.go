...
func newUserBasic(db *gorm.DB, opts ...gen.DOOption) userBasic {
	...
	_userBasic.Country = field.NewString(tableName, "country")
	_userBasic.Province = field.NewString(tableName, "province")
	_userBasic.City = field.NewString(tableName, "city")
	_userBasic.District = field.NewString(tableName, "district")
