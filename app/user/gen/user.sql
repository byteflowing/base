...
CREATE UNIQUE INDEX idx_basic_uni_biz_phone ON user_basic (phone_country_code, phone);
CREATE UNIQUE INDEX idx_basic_uni_biz_email ON user_basic (email);
...
CREATE INDEX idx_sign_access_session_id ON user_sign_log (access_session_id);
CREATE INDEX idx_sign_refresh_session_id ON user_sign_log (refresh_session_id);
