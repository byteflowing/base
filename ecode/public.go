...
var (
	...
	ErrPhoneNotExist    = status.New(codes.NotFound, "ERR_PHONE_NOT_EXIST").Err()            // 手机号码不存在
	ErrEmailNotExist    = status.New(codes.NotFound, "ERR_EMAIL_NOT_EXIST").Err()            // 邮箱不存在
	...
	ErrPhoneExists      = status.New(codes.AlreadyExists, "ERR_PHONE_EXISTS").Err()          // 手机已存在
	ErrEmailExists      = status.New(codes.AlreadyExists, "ERR_EMAIL_EXISTS").Err()          // 邮箱已存在
