...
require (
	github.com/byteflowing/go-common v0.0.0-20250728031958-8f53940f576a
	gorm.io/gen v0.3.27
)
...
require (
	...
	github.com/volcengine/ve-tos-golang-sdk/v2 v2.7.9 // indirect
	github.com/volcengine/volc-sdk-golang v1.0.200 // indirect
